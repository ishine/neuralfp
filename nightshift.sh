#!/bin/sh
python test.py --test_dir=data/test_data/fma_large --model_path=model/model_ver6_epoch_300.pth
...
python test.py --fp_path=fingerprints/fma_large_ver6.pt --model_path=model/model_ver6_epoch_300.pth --query_dir=data/fma_large_10sec_5H --eval=True
