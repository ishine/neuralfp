#!/bin/sh
# python test.py --test_dir=data/test_data/fma_large --model_path=model/model_ver230_epoch_7.pth
...
python test.py --fp_path=fingerprints/fma_large_ver7.pt --model_path=model/model_ver230_epoch_7.pth --query_dir=data/fma_large_10sec_2H --eval=True
