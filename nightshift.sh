#!/bin/sh
python test.py --test_dir=data/test_data/fma_large --model_path=model/model_ver5_epoch_230.pth
...
python test.py --fp_path=fingerprints/fma_large_ver5.pt --model_path=model/model_ver5_epoch_230.pth --query_dir=data/fma_large_10sec_2K --eval=True >> results/fma_large_10sec_2K.txt
