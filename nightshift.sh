#!/bin/sh
python test.py --test_dir=data/test_data/fma_large --model_path=model/model_ver3_epoch_260.pth
...
python test.py --fp_path=fingerprints/fma_large_ver3.pt --model_path=model/model_ver3_epoch_260.pth --query_dir=data/fma_large_10sec_2K --eval=True
