#!/bin/sh
python test.py --test_dir=data/test_data/fma_large --model_path=model/model_ver7_epoch_100.pth
python create_query_data.py --length 11 --test_dir=data/test_data/fma_large --noise_dir=data/Noises_unsampled --ir_dir=data/IR_unsampled
...
python test.py --fp_path=fingerprints/fma_large_ver5.pt --model_path=model/model_ver7_epoch_100.pth --query_dir=data/fma_large_11sec_2K --eval=True
